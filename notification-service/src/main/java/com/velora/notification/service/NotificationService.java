...
public class NotificationService {
    ...
    public void saveNotification(String eventType, String rawMessage) throws Exception {
        ...
        if ("PAYMENT_SUCCESS".equals(eventType)) {
            ...
            message = "Hi " + username + ", payment for order " + orderId + " gagal. Saga compensation dijalankan untuk release stock.";
        } else if ("SHIPMENT_FAILED".equals(eventType)) {
            message = "Hi " + username + ", shipment for order " + orderId + " gagal. Saga compensation akan refund payment dan release stock.";
        } else if ("PAYMENT_REFUNDED".equals(eventType)) {
            message = "Hi " + username + ", payment for order " + orderId + " sudah direfund karena shipment gagal.";
        } else {
